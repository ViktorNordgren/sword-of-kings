...
void Engine::drawHeroBattle()
{
    ...
    glBegin(GL_POLYGON);
        glTexCoord2f(0.0f, 0.0f);
        glVertex2f(6 + heroBattleAnimationX * 17, 8);
        glTexCoord2f(1.0f, 0.0f);
        glVertex2f(8 + heroBattleAnimationX * 17 + hero->getWidth(), 8);
        glTexCoord2f(1.0f, 1.0f);
        glVertex2f(8 + heroBattleAnimationX * 17 + hero->getWidth(), 8 + hero->getHeight());
        glTexCoord2f(0.0f, 1.0f);
        glVertex2f(6 + heroBattleAnimationX * 17, 8 + hero->getHeight());
    glEnd();
